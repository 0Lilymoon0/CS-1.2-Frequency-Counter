...
Count the number of occurrences of each word in the file, and print all of those words and their frequencies.
...
print(f"🖨  All done! Here are all of the words from {filename} and \n their frequencies:\n")
